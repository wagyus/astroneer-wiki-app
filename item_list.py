...
tk.Label(root, text="-").grid(row=3, column=6)
tk.Label(root, text="-").grid(row=4, column=6)
tk.Label(root, text="-").grid(row=5, column=6)
tk.Label(root, text="-").grid(row=6, column=6)
tk.Label(root, text="-").grid(row=7, column=6)
tk.Label(root, text="-").grid(row=8, column=6)
tk.Label(root, text="-").grid(row=9, column=6)
tk.Label(root, text="-").grid(row=10, column=6)
tk.Label(root, text="-").grid(row=11, column=6)
tk.Label(root, text="-").grid(row=12, column=6)
tk.Label(root, text="-").grid(row=13, column=6)
tk.Label(root, text="-").grid(row=14, column=6)
tk.Label(root, text="-").grid(row=15, column=6)
tk.Label(root, text="-").grid(row=16, column=6)

tk.Label(root, text="ATHMOSPHERIC CONDENSOR").grid(row=0, column=7,)
